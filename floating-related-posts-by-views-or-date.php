							...
							if($Add_Excerpt==='YES') {
								if(has_excerpt()) {
									...
									if(isset($metaNameDescription)) {
										$Excerpt_picked_post = '&nbsp;<p style="color: '.$Excerpt_Color.'; line-height: 90%;">&nbsp;<i>"'.$metaNameDescription.'"</i></p>';
									} else {
										$Excerpt_picked_post = '&nbsp;<p style="color: '.$Excerpt_Color.'; line-height: 90%;">&nbsp;<i>"'.substr(get_the_content(), 0, 180).'..."</i></p>';
									}
								}
							}
